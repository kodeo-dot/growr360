  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      {!groupId ? <EmptyWorkspace onGroups={() => setGroupBrowserOpen(true)}/> : <>
        ...
        {view === "equipo" && <RealTeamView section="members" groupId={groupId} members={members} fields={fields} plots={plots} currentRole={activeMembership?.role ?? "producer"} canManage={hasPermission("manage_members")} memberLimit={currentPlan?.max_users??null} onSection={setView} onSaved={() => void loadGroupData(groupId, true)}/>}
        {view === "solicitudes" && <RealTeamView section="requests" groupId={groupId} members={members} fields={fields} plots={plots} currentRole={activeMembership?.role ?? "producer"} canManage={hasPermission("manage_members")} memberLimit={currentPlan?.max_users??null} onSection={setView} onSaved={() => void loadGroupData(groupId, true)}/>}
        {view === "invitaciones" && <RealTeamView section="invitations" groupId={groupId} members={members} fields={fields} plots={plots} currentRole={activeMembership?.role ?? "producer"} canManage={hasPermission("manage_members")} memberLimit={currentPlan?.max_users??null} onSection={setView} onSaved={() => void loadGroupData(groupId, true)}/>}
